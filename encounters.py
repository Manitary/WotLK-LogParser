encounter_creature = {
    ...
    'Noth the Plaguebringer': ('Noth the Plaguebringer', 'Plagued Warrior', 'Plagued Champion', 'Plagued Guardian'),
    "Anub'Rekhan": ("Anub'Rekhan", 'Crypt Guard',),
    'Sapphiron': ('Sapphiron',),
    'Loatheb': ('Loatheb',),
    'Patchwerk': ('Patchwerk',),
    'Gothik the Harvester': ('Gothik the Harvester', 'Unrelenting Trainee', 'Unrelenting Death Knight', 'Unrelenting Rider', 'Spectral Trainee', 'Spectral Death Knight', 'Spectral Rider', 'Spectral Horse',),
